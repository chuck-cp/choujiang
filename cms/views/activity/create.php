...
<form class="layui-form" style="width:80%;" id="qq">
	<div class="layui-form-item layui-row layui-col-xs12">
		...
		<div class="layui-input-block">
			<input type="text" class="layui-input name" name="title" id="sss" lay-verify="required" placeholder="请输入活动名称">
		</div>
	</div>
	<div class="layui-form-item layui-row layui-col-xs12">
		<label class="layui-form-label">活动副标题</label>
		<div class="layui-input-block">
			<input type="text" class="layui-input mobile" name="subtitle" lay-verify="required" placeholder="请输入活动副标题">
		</div>
	</div>
	<div class="layui-row">
        <div class="layui-form-item layui-row layui-col-xs12">
            <div class="prize">
                ...
                <div class="layui-input-block">
                    <input type="text" class="layui-input" name="start_at"  id="start_at" lay-verify="required" placeholder="开始时间" name="createtime" style="height:38px;width:180px;">
                </div>
            </div>
            <div class="prize">
                <label  class="layui-form-label"></label>
                <div class="layui-input-block">
                    <input type="text" class="layui-input" name="end_at" id="end_at" lay-verify="required" placeholder="结束时间" name="createtime" style="height:38px;width:180px;">
                </div>
            </div>
		</div>
	</div>
                ...
                <div class="prize">
                    <div class="layui-input-block">
                        <div style="float: left;width: 145px;">
                            <button style="margin-top: 20px;" type="button" cid="1" class="layui-btn layui-btn-sm  imgs" >上传图片</button>
                        </div>
                        <div style="float: left; margin-left: 20px;" class="layui-upload-list">
                            <img width="35%" class="layui-upload-img" id="img1">
                            <input type="hidden" name="prize_image[]" id="prize_image1">
                            <p id="demoText"></p>
                        </div>
                    </div>
                </div>
    ...
    <div class="layui-row">
        <div class="layui-form-item layui-row layui-col-xs12">
            <label class="layui-form-label"></label>
            <div class="layui-input-block">
                <button  type="button" zid="1" class="layui-btn layui-btn-normal add-prize">增加奖项</button>
            </div>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input type="radio" name="is_choice" value="1" title="是">
            <input type="radio" name="is_choice" value="0" title="否" checked="">
        </div>
    </div>
	<div class="layui-form-item layui-row layui-col-xs12">
		<div class="layui-input-block">
			<button class="layui-btn layui-btn-sm" lay-submit="" lay-filter="addActivity">立即添加</button>
...
<script type="text/javascript" src="/static/js/activityAdd.js?v=201907188"></script>
