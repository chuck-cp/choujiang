...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header header">
        <div class="layui-main mag0">
            ...
            <ul class="layui-nav topLevelMenus" pc>
                ...
                <li class="layui-nav-item layui-this" data-menu="activity">
                    <a href="javascript:;"><i class="layui-icon" data-icon="&#xe63c;">&#xe63c;</i><cite>抽奖活动</cite></a>
                </li>
                <!--<li class="layui-nav-item" data-menu="memberCenter" pc>
                ...
                <li class="layui-nav-item" data-menu="aA" pc>
                    <a href="javascript:;"><i class="layui-icon" data-icon="&#xe705;">&#xe705;</i><cite>测试</cite></a>
                </li>-->
            </ul>
            <!-- 顶部右侧菜单 -->
            <ul class="layui-nav top_menu">
                <li class="layui-nav-item" id="userInfo">
                    <a href="javascript:;"><img src="/static/images/face.jpg" class="layui-nav-img userAvatar" width="35" height="35"><cite class="adminName"><?=Yii::$app->user->identity->username?></cite></a>
                    <dl class="layui-nav-child">
                        ...
                        <dd><a href="javascript:;" data-url="/static/page/user/changePwd.html"><i class="seraph icon-xiugai" data-icon="icon-xiugai"></i><cite>修改密码</cite></a></dd>
                        <dd><a href="<?=\yii\helpers\Url::to(['logout'])?>" class="signOut"><i class="seraph icon-tuichu"></i><cite>退出</cite></a></dd>
                    </dl>
                </li>
            </ul>
        </div>
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            ...
            <p>你好！<span class="userName"><?=Yii::$app->user->identity->username?></span>, 欢迎登录</p>
        </div>
        <!-- 搜索 -->
        <div class="navBar layui-side-scroll" id="navBar">
            <ul class="layui-nav layui-nav-tree">
                <li class="layui-nav-item layui-this">
                    <a href="javascript:;" data-url="/static/page/main.html"><i class="layui-icon" data-icon=""></i><cite>后台首页</cite></a>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="layui-tab mag0" lay-filter="bodyTab" id="top_tabs_box">
            ...
            <div class="layui-tab-content clildFrame">
                <div class="layui-tab-item layui-show">
                    <iframe id="contents" src="<?=\yii\helpers\Url::to(['site/system'])?>"></iframe>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="layui-footer footer">
        <p><span>copyright @2019 抽奖活动</span></p>
    </div>
</div>
<!-- 移动导航 -->
